...
<body class="bg-light">
    ...
    <div class="dashboard-wrapper">
        ...
        <main class="main-content">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h3 class="fw-bold mb-0">Account Settings</h3>
                    <p class="text-muted small mb-0">Manage your personal identity and security credentials.</p>
                </div>
            </div>
            ...
            <div class="row g-4">
                <div class="col-lg-4">
                    <div class="glass-card p-4 text-center settings-card shadow-sm">
                        ...
                        <p class="text-muted small mb-4"><?php echo ucfirst($role); ?> — Institutional Head</p>
                        ...
                        <div class="list-group list-group-flush text-start small border-top pt-3">
                            ...
                            <div class="list-group-item bg-transparent border-0 px-0 d-flex justify-content-between">
                                ...
                                <span class="fw-semibold">#ER-<?php echo str_pad($user_id, 4, '0', STR_PAD_LEFT); ?></span>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <form id="personalInfoForm">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-text">To change your primary email, please contact EduRemarks support.</div>
                                        </div>
                                    ...
                                    <div class="row g-3">
                                        <div class="col-12">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="password" class="form-control" name="current_password" id="curr_pass" required>
                                                <span class="input-group-text password-toggle" data-target="curr_pass"><i class="fas fa-eye-slash"></i></span>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="password" class="form-control" name="new_password" id="new_pass" required minlength="6">
                                                <span class="input-group-text password-toggle" data-target="new_pass"><i class="fas fa-eye-slash"></i></span>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="password" class="form-control" name="confirm_password" id="conf_pass" required minlength="6">
                                                <span class="input-group-text password-toggle" data-target="conf_pass"><i class="fas fa-eye-slash"></i></span>
                                            </div>
                                        </div>
                                        <div class="col-12 pt-3 border-top mt-4">
    ...
    <div id="successOverlay" style="display:none; position:fixed; inset:0; background:rgba(15,23,42,0.85); backdrop-filter:blur(12px); z-index:99999; align-items:center; justify-content:center; flex-direction:column;">
        <div class="reveal reveal-scale shadow-2xl" style="background:white; border-radius:40px; padding:50px; text-align:center; max-width:420px; width:90%; border:1px solid rgba(255,255,255,0.1);">
            ...
            <h4 class="fw-bold mb-2 text-dark">Profile Synchronized</h4>
            <p class="text-muted small mb-4">Your administrative profile and security protocols have been successfully updated.</p>
    ...
    <script>
        ...
        picInput.addEventListener('change', function(e) {
            ...
            fd.append('full_name', '<?php echo $user_full_name; ?>'); // Required by AJAX

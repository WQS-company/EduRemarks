<?php
// admin/print_agreement.php
require_once '../includes/auth_check.php';

if ($role !== 'owner' && $role !== 'super_admin') {
    die("Unauthorized access to institutional commercial documents.");
}

$school_id = $active_school['id'] ?? null;
if (!$school_id) die("No active institutional node selected.");
...
// Safeguard: Only allow printing if subscription is active
if ($school['billing_mode'] !== 'subscription' || !$school['subscription_active']) {
    die("This institution is currently on a credit-based economy. No period agreement discovered.");
}
...
<head>
    ...
    <title>Institutional Billing Agreement | <?php echo htmlspecialchars($school['school_name']); ?></title>

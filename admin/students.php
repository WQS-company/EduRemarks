...
<?php endif; ?>
        ...
        <div class="d-flex flex-column flex-lg-row align-items-lg-center justify-content-between gap-3 mb-4">
            ...
            <div class="header-buttons d-flex align-items-center gap-2 flex-wrap flex-md-nowrap w-mobile-100 justify-content-md-end">
                ...
                <a href="student_portal.php" class="btn-modern btn-modern-primary d-flex align-items-center text-decoration-none shadow-sm justify-content-center" style="background: linear-gradient(135deg, #1e40af, #3b82f6); border:none;">
                    <i class="fas fa-user-shield me-2"></i> Manage Portal
                </a>
                <a href="student_bulk_upload.php" class="btn-modern btn-modern-primary d-flex align-items-center text-decoration-none shadow-sm justify-content-center" style="background: linear-gradient(135deg, #1e40af, #3b82f6); border:none;">
                                             ...
                                             <?php endif; ?>
                                              <?php if (!empty($st['department_name'])): ?>
                                                  <span class="badge bg-info bg-opacity-10 text-info border border-info border-opacity-10 px-2 py-1 rounded-pill" style="font-size:0.6rem; letter-spacing:0.5px;">
                                                      <i class="fas fa-<?php echo (get_label('Section') === 'Department') ? 'university' : 'layer-group'; ?> me-1"></i><?php echo htmlspecialchars($st['department_name']); ?>
                                                  </span>
                                              <?php endif; ?>
                                         </div>
                                     </div>
            ...
            <div class="col-xl-4 col-lg-5" id="addStudentsPanel">
                <div class="glass-card p-4 h-100 position-relative border border-primary border-opacity-10 shadow-sm" style="background: linear-gradient(180deg, #ffffff 0%, #f8fafc 100%);">
                    ...
                    <div class="mb-3 bg-white p-3 rounded-4 border shadow-sm">
                        <label class="form-label small fw-800 text-dark text-uppercase tracking-1 mb-2" style="font-size:0.7rem;"><i class="fas fa-university text-primary me-2"></i><?php echo get_label('Section'); ?></label>
                        <select class="form-select bg-light border-0 fw-bold px-3 py-2 text-dark shadow-none" id="multiTargetDept" style="border-radius:10px;">
                            <option value="">— Select <?php echo get_label('Section'); ?> —</option>
            ...
            <form id="editStudentForm">
                ...
                <div class="modal-body p-4 bg-white">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            <label class="form-label fw-800 text-muted small uppercase tracking-1"><?php echo get_label('Section'); ?></label>
                            <select class="form-select bg-light border-0 fw-bold px-3 py-2" name="department_id" id="edit_department_id">
                                <option value="">— No <?php echo get_label('Section'); ?> —</option>
                                <?php foreach ($departments as $d): ?>
                                    <option value="<?php echo $d['id']; ?>"><?php echo htmlspecialchars($d['section_name']); ?></option>
                                <?php endforeach; ?>
                            </select>

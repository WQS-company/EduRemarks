...
<body class="bg-light">
    ...
    <div class="dashboard-wrapper">
        <?php 
            if ($role === 'super_admin') include '../includes/sa_sidebar.php';
            elseif ($role === 'owner') include '../includes/admin_sidebar.php';
            else include '../includes/staff_sidebar.php';
        ?>
                        ...
                        <div class="glass-card p-4 mb-4">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select border-0 bg-light fw-bold" id="examTerm">
                                    <option value="<?php echo get_label('1st Term'); ?>"><?php echo get_label('1st Term'); ?></option>
                                    <option value="<?php echo get_label('2nd Term'); ?>"><?php echo get_label('2nd Term'); ?></option>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select border-0 bg-light fw-bold" id="examType">
                                    ...
                                    <option value="exam"><?php echo (get_label('Term') === 'Semester') ? 'Semester' : 'Terminal'; ?> Examination</option>
                                </select>
                            </div>
                        </div>

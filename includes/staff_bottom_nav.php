...
<div class="sa-bottom-nav">
    ...
    <a href="lessons.php" class="bottom-nav-item <?php echo ($current_page == 'lessons.php') ? 'active' : ''; ?>">
...
<div class="offcanvas offcanvas-bottom" tabindex="-1" id="mobileMoreOffcanvas" style="border-radius: 20px 20px 0 0; height: auto;">
  <div class="offcanvas-header pb-0 border-0">
    <h6 class="offcanvas-title fw-800 text-primary">System Functions</h6>
    ...
    <div class="row g-3 text-center pb-4">
        ...
        <div class="col-4">
            <a href="curriculum.php" class="text-decoration-none">
                <div class="bg-info bg-opacity-10 text-info rounded-4 p-3 mb-2 mx-auto d-flex align-items-center justify-content-center" style="width: 50px; height: 50px;"><i class="fas fa-scroll"></i></div>

<?php
// user/admission_portal.php - Staff Admission Application Management Center
require_once '../includes/auth_check.php';

// Staff Permission Guard
if (!$staff_permissions['can_manage_students']) {
...
if (!$config) {
    // If config doesn't exist, staff can't initialize it, only owners
    $_SESSION['sys_error'] = "Admission portal has not been initialized by the institutional administrator.";
    header('Location: dashboard.php');
    exit();
}
...
<body>
    ...
    <div class="dashboard-wrapper">
        ...
        <main class="main-content">
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-7">
                            <div class="badge bg-white bg-opacity-10 text-white mb-2 px-3 py-2 rounded-pill small fw-800">
                                <i class="fas fa-id-badge me-2"></i> STAFF NODE &bull; ADMISSIONS
                            </div>
                            <h2 class="fw-900 mb-2">Applicants Registry</h2>
                            <p class="opacity-75 mb-0">Review and process student intake applications for <?php echo htmlspecialchars($active_school['school_name']); ?>.</p>
                            ...
                            ?>
                                ...
                                <div class="mt-2 extra-small opacity-50 fw-bold">
                                    <i class="fas fa-coins me-1 text-warning"></i> Institutional Rate: <?php echo getCreditRate('credit_admission_applicant', $pdo); ?> Credits / Applicant
                                </div>
                            </div>
                        </div>
                        <div class="col-md-5 text-md-end mt-4 mt-md-0">
                            ...
                            ?>
                                <div class="bg-white bg-opacity-10 p-3 rounded-4 mb-0 text-start border border-white border-opacity-10">
                            ...
                            <table class="table table-hover align-middle mb-0">
                                <thead class="bg-light">
                                    <tr>
                                        ...
                                        <th class="py-3 extra-small fw-800 uppercase tracking-2 opacity-50">Class applied</th>
            ...
            <div class="p-4 text-center">
                <div class="extra-small fw-800 text-muted uppercase tracking-2">EduRemarks Operational Intelligence</div>
            </div>
        </main>
    </div>
                    ...
                    <div class="row g-3 align-items-stretch">
                        <div class="col-md-3">
                            <div class="p-3 bg-light rounded-4 h-100">
                                ...
                                <div class="mb-2"><span class="small text-muted">Class:</span> <div class="fw-800 text-primary" id="v_class"></div></div>
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-6">
                                            ...
                                            <div class="mb-0" id="singleClassArea" style="display: none;">
                                                <label class="small fw-800 mb-1">Final Class</label>
    ...
    <script>
        ...
        function openBatchModal() {
            ...
            const massModal = new bootstrap.Modal('#batchModal');
            massModal.show();
        ...
        function updateSmsCost() {
            const count = $('.app-checkbox:checked').length;
            const msgLen = $('#b_sms').val().length || 100;
        ...
        function viewApplication(app) {
            ...
            $('#batchBar').addClass('hidden-by-modal');
            const dModal = new bootstrap.Modal('#appModal');
            dModal.show();
